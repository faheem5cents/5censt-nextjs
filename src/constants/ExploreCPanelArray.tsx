...
export const ExploreCPanelArray = [
	{
		img: LiveEventStreaming,
		heading: "Live Event Streaming",
		description:
	...
	{
		img: IPCamRestreaming,
		heading: "IP cam Restreaming",
		description:
	...
	{
		img: WebsiteAcceleration,
		heading: "Website Acceleration",
		description:
	...
	{
		img: WebApplicationAcceleration,
		heading: "Web Application Acceleration",
		description:
	...
	{
		img: SatelliteDownlink,
		heading: "Satellite Downlink",
		description:
