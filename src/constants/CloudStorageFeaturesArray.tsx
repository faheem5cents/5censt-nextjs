...
export const CloudStorageFeaturesArray = [
    ...
    },
    {
        ...
        description: 'Our partners are guaranteed to be connected to world-class networks and experience high-quality services with Tier 1 IP transit providers along with major ISP’s across the globe.'
    },
    {
        img: FlatPricing,
