...
export const VSVideoEncodingFeaturesArray = [
    {
    ...
    },
    {
        ...
        description: "Improve your viewer’s experience by delivering the live streaming content using adaptive bitrate streaming to suit the viewer's connection speed."
    },
    {
