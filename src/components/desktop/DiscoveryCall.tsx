				...
				<div className="max-w-[1140px] mx-auto">
					<div className="p-[30px] lg:p-[10px]">
						<div className="mb-5 mx-[10%]">
							<h2
								className="text-white text-[30px] md:text-[34px] lg:text-[40px] font-bold leading-[1.4em] text-center"
						...
						<div className="mb-5">
							<div className="flex justify-center items-center gap-10 relative">
								<Image
									className="absolute md:w-[123px] lg:w-[190px] md:top-[-55%] md:right-[7%] lg:right-[16%] top-[-52%] hidden md:block"
									src={SayHiIcon}
									alt=""
								/>
								<div>
								...
								<div className="flex items-center flex-col md:flex-row justify-between w-full">
									<div className="w-full md:w-[70%] p-[10px]">
										...
										<p className="mb-[30px] text-left text-[#cfcfcf] text-base leading-[1.5]">
											We`&apos;`d love to learn more about you!👂 In this short
											call, we`&apos;`ll figure out your business needs and see
											if our product is right for you.
										</p>
										<a
											href="#"
