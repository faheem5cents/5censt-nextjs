...
import DeliveryAccelerationTabIcon from "@/assets/CDN/DeliveryAccelerationTab.svg";
...
const CDNDeliveryAccelerationPage = () => {

    const [activeTab, setActiveTab] = useState('Delivery Acceleration');
...
export default CDNDeliveryAccelerationPage;